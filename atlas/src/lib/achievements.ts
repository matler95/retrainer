...
export const ACHIEVEMENTS: Achievement[] = [
  ...
  },
  {
    id: "week-streak",
    title: "Week Warrior",
    description: "Train 3 days in a week.",
    icon: "🔥",
    category: "streak",
    condition: (ctx) => ctx.totalWorkouts >= 3,
  },
  {
    id: "two-week-streak",
    title: "Consistent",
    ...
    icon: "💪",
    category: "streak",
    condition: (ctx) => ctx.totalWorkouts >= 7,
  },
  {
    id: "month-streak",
    ...
    icon: "⚡",
    category: "streak",
    condition: (ctx) => ctx.totalWorkouts >= 15,
  },
  {
    id: "hundred-club",
    title: "Century Club",
  ...
  // ── Volume ──
  {
    id: "volume-1000",
    title: "Light Weight",
    description: "Lift a cumulative 1,000 kg across all sessions.",
    icon: "🏋️",
    category: "volume",
    condition: (ctx) => ctx.totalVolumeKg >= 1000,
  },
  {
    id: "volume-10000",
    title: "Heavy Lifter",
    description: "Lift a cumulative 10,000 kg across all sessions.",
    icon: "🏋️",
    category: "volume",
    condition: (ctx) => ctx.totalVolumeKg >= 10_000,
  },
  {
    id: "volume-100000",
    title: "Legendary Volume",
    description: "Lift a cumulative 100,000 kg across all sessions.",
    icon: "💎",
    category: "volume",
    condition: (ctx) => ctx.totalVolumeKg >= 100_000,
  },
  ...
  // ── Strength ──
  {
    id: "sets-100",
    title: "Set Seeker",
    description: "Complete 100 sets total.",
    icon: "📊",
    category: "strength",
    condition: (ctx) => ctx.totalSetsLogged >= 100,
  },
  {
    id: "sets-1000",
    title: "Set Master",
    description: "Complete 1,000 sets total.",
    icon: "📈",
    category: "strength",
    condition: (ctx) => ctx.totalSetsLogged >= 1000,
  },

  // ── Consistency ──
  {
    id: "weigh-in-streak-7",
    title: "Tracking",
    description: "Log your body weight 7 times.",
    icon: "⚖️",
    category: "consistency",
    condition: (ctx) => ctx.bodyWeight.length >= 7,
  },
  {
    id: "weigh-in-streak-30",
    title: "Data Driven",
    description: "Log your body weight 30 times.",
    icon: "📉",
    category: "consistency",
    condition: (ctx) => ctx.bodyWeight.length >= 30,
  },
  ...
  // ── Milestone ──
  {
    ...
    icon: "✅",
    category: "milestone",
    condition: () => true, // unlocked by default once profile exists
  },
  {
    id: "plan-generated",
    title: "Planned",
    ...
    icon: "📋",
    category: "milestone",
    condition: () => true, // unlocked by default once plan exists
  },
];
